...
import SabongLogo from "../../../assets/icons/cbcash-logo.png";
    ...
    return (
        <div className="dapp-sidebar">
            <div className="branding-header">
                <Link href="https://cryptobet-cash.web.app/">
                    <img alt="" src={SabongLogo} width="150px" height="90px" />
                </Link>
            ...
            <div className="dapp-menu-doc-link">
                <Link href="http://sabong.gitbook.io/" target="_blank">
