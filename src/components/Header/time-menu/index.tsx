...
function TimeMenu() {
    ...
    const SSAB_ADDRESS = addresses.SSAB_ADDRESS;
    const SAB_ADDRESS = addresses.SAB_ADDRESS;
                        ...
                        <div className="tooltip">
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("SAB", SAB_ADDRESS)}>
                                        <p>SAB</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("sSAB", SSAB_ADDRESS)}>
                                        <p>sSAB</p>
                                    </div>
                                </div>
                            )}
